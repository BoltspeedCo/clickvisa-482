  ...
  return (
    ...
    >
      <Container size="wide">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:gap-8 lg:gap-12 xl:gap-24">
          {partners.map((person, index) => {
            const { description, image, name, email, phone, position } = person
            return (
              <div className="col-span-1 max-w-2xl grid md:grid-cols-7 md:gap-6 lg:gap-8" key={index}>
                ...
                <div className="col-span-7 lg:col-span-4 mt-5 md:mt-0">
