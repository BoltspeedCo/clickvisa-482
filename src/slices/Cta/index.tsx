    ...
    >
      <Container size="wide" className="px-4">
        <div className="bg-foreground relative overflow-hidden">
          <div className="absolute w-full md:w-2/3 lg:w-1/2 right-0 h-[200px] md:h-full bottom-0 md:top-0 overflow-hidden">
          ...
          <div className="absolute w-full md:w-2/3 lg:w-1/2 h-[200px] md:h-full bottom-0 md:top-0 right-0 bg-radial-gradient-foreground">

          </div>
          <div className="max-w-4xl mx-auto relative">
            <div className=" max-w-lg  text-background pt-12 pb-32 p-6 md:p-8 lg:p-12 xl:p-16 text-left md:text-center flex flex-col md:items-center">
              <SmartText text={preHeading} variant="h5" size="h6" className=" font-normal mb-3 lg:mb-4 capitalize " />
              <SmartText text={heading} variant="h2" className="font-bold uppercase md:max-w-xs" />
